...
function readFormData() {
    ...
    formData["darbalaiks"] = document.getElementById("darbalaiks").value;
    return formData;
}
function insertNewRecord(data) {
    ...
    cell3.innerHTML = data.darbalaiks;
...
function resetForm() {
    ...
    document.getElementById("darbalaiks").value = "";
    selectedRow = null;
}
...
function onEdit(td) {
    ...
    document.getElementById("darbalaiks").value = selectedRow.cells[2].innerHTML;
}
function updateRecord(formData) {
    selectedRow.cells[0].innerHTML = formData.slimnica12;
    selectedRow.cells[1].innerHTML = formData.location12;
    selectedRow.cells[2].innerHTML = formData.darbalaiks;
}
